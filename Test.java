...
public class Test {
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            System.out.println("Elapsed time: " + (end - start) + "us");
            bufferedWriter.write("n=" + array.length + "\nAlgorithm: Insertion Sort\n" + "Elapsed time: " + (end - start) + "us");
        ...
        System.out.println("Unsorted first array:");
        SortArray.print(array1);

        System.out.println("Unsorted second array:");
        SortArray.print(array2);

        SortArray.twoWayMergeSort(array1, array2, array3);

        System.out.println("Merged and sorted third array:");
        SortArray.print(array3);
    }
}
